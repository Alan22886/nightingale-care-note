type PatientReleaseCandidate = { visibility?: string; entry_type?: string; author_role?: string; trust_state?: string; release_state?: string };
...
export function isPatientReleased(candidate: PatientReleaseCandidate) {
  ...
  return candidate.visibility === 'patient'
    && candidate.release_state === 'released'
