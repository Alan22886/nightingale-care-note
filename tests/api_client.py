...
REQUEST_TIMEOUT=float(os.environ.get('NIGHTINGALE_REQUEST_TIMEOUT','15'))
class Client:
    ...
    def request(self,path,method='GET',body=None):
        ...
        try:
            with self.opener.open(req,timeout=REQUEST_TIMEOUT) as response:return response.status,json.loads(response.read() or b'{}')
